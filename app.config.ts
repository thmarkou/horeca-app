...
const rawBundleId = "space.manus.horeca_mobile_app.t20260413174930";
const bundleId =
  rawBundleId
...
const env = {
  ...
  appName: "Horeca Source",
  appSlug: "horeca_mobile_app",
  // S3 URL of the app logo - set this to the URL returned by generate_image when creating custom logo
  // Leave empty to use the default icon from assets/images/icon.png
  logoUrl: "https://d2xsxph8kpxj0f.cloudfront.net/310519663172583062/dzFZaarnb6mDYmwpV5KL2u/horeca-source-icon-YUE3GiZc9HHTh2v6QQyKj3.png",
